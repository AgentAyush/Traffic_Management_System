...
menuframe=Frame(root,bg='misty rose',pady=8,bd=10,relief=RIDGE)
menuframe.pack(side=LEFT)
intro2=Frame(menuframe,bg='misty rose',pady=5,bd=10,relief=RIDGE)
...
menu=Frame(menuframe,bg='papaya whip',pady=5,bd=10,relief=RIDGE)
menu.pack(side=TOP)
...
def recipt():
    ...
    fra.pack(side=TOP)
    root1.title('Receipt')
    txtreceipt=Text (fra,width = 60, height = 100, bg = "khaki1", bd = 4, font = ('arial', 12, 'bold'))
    ...
    if (var19.get()==1):
        txtreceipt.insert(END,'Driving when unfit to drive:\t\t\t'+str(second2.get())+'\n')
    ...
    #txtreceipt.insert(END,'Date:\t'+Date.get()+'\n')
    if(name.get()==''):
        tkinter.messagebox.showinfo("program",'Please Enter  Your Name')
        txtreceipt.delete("1.0",END)
    if(len(age.get())<2):
        tkinter.messagebox.showinfo("program",'Please Enter Proper Age')
        txtreceipt.delete("1.0",END)
    if(len(age.get())>2):
        tkinter.messagebox.showinfo("program","Please Enter Proper Age")
        txtreceipt.delete("1.0",END)
    if(gender.get()==''):
        tkinter.messagebox.showinfo("program",'Please Provide Your Gender')
        txtreceipt.delete("1.0",END)
    if(len(phone.get())<=9):
        tkinter.messagebox.showinfo("program",'Please  Review the Contact No')
        txtreceipt.delete("1.0",END)
    if(len(phone.get())>=11):
        tkinter.messagebox.showinfo("program",'Please Review the Contact No')
        txtreceipt.delete("1.0",END)
    if(addr.get()==''):
        tkinter.messagebox.showinfo("program",'Please Enter Your Address')
        txtreceipt.delete("1.0",END)
    if(coste.get()==' '):
    ...
    if not a.isalpha():     
        name.set(' ')
        tkinter.messagebox.showinfo("Information","Name should not contain numbers")
    if not g.isnumeric():
        age.set(' ')
        tkinter.messagebox.showinfo("Information","Age should not contain characters")
    
    
    if a.isalpha() and g.isnumeric():
...
def cost():
    ...
    if (name.get().isnumeric()):
        name.set(" ")
        tkinter.messagebox.showinfo("program", 'Name should not contain numbers')
    if (age.get().isalpha()):
        age.set(" ")
        tkinter.messagebox.showinfo('program', 'Age should not contain alphabets')
    if(gender.get()==''):
        tkinter.messagebox.showinfo("program",'Please Enter Gender')
    if(len(phone.get())<=9):
        tkinter.messagebox.showinfo("program",'Please Review Your Phone No')
    if(len(phone.get())>=11):
        tkinter.messagebox.showinfo("program",'Please Review Your Phone No')
    if(addr.get()==''):
...
def cause():
    if(var26.get()==1):
        ...
        causing.set('0')
#labels
head=Label(top,text='\t New Traffic Policy\t\t',bg='LightGoldenrod2',
           fg='black',font=('algerian 40 bold'),justify=CENTER)
...
#menu
General=Checkbutton(menu,text='General',font=('arial 16 bold'),bg='papaya whip',
                    variable=var7,onvalue=1,offvalue=0,command=generaly).grid(row=0,column=0,sticky=W)
First1=Checkbutton(menu,text='First-Time',font=('arial 16 bold'),bg='papaya whip',
                   variable=var8,onvalue=1,offvalue=0,command=first1).grid(row=0,column=1,sticky=W)
Second1=Checkbutton(menu,text='Second-Time',font=('arial 16 bold'),bg='papaya whip',
...
Ticketless=Checkbutton(menu,text='Without Road Tax payer',font=('arial 16 bold'),
                       ...
                       bg='papaya whip').grid(row=1,column=0,sticky='w')
...
Violation=Checkbutton(menu,text='Violation of road regulation\t\t\t',font=('arial 16 bold'),
                      ...
                      bg='papaya whip').grid(row=2,column=0,sticky=W)

Disobedience=Checkbutton(menu,text='Disobediance of order of Authority\t\t',font=('arial 16 bold'),
                         bg='papaya whip',variable=var12,onvalue=1,command=diso,
...
Unauthorised=Checkbutton(menu,text='Unauthorised use of vehicles without license\t',font=('arial 16 bold')
                         ...
                         bg='papaya whip').grid(row=4,column=0,sticky=W)

DrivingW=Checkbutton(menu,text='Driving Without license\t\t\t',font=('arial 16 bold'),
                     bg='papaya whip',variable=var14,onvalue=1,command=drivw,
...
Drivingd=Checkbutton(menu,text='Driving despite disqualification\t\t\t\t\t\t',font=('arial 16 bold'),
                     bg='papaya whip',variable=var15,onvalue=1,command=drivd,
                     offvalue=0).grid(row=6,column=0,sticky=W)
Over=Checkbutton(menu,text='Over-Speeding\t\t\t\t',font=('arial 16 bold'),bg='papaya whip',
                 variable=var16,onvalue=1,command=overs,
                 offvalue=0).grid(row=7,column=0,sticky=W)

Dan=Checkbutton(menu,text='Traffic Light Violation \t\t\t\t',font=('arial 16 bold'),bg='papaya whip',
                variable=var17,onvalue=1,command=dango,
                offvalue=0).grid(row=8,column=0,sticky=W)
Drunk=Checkbutton(menu,text='Drunk Driving\t\t\t\t',font=('arial 16 bold'),bg='papaya whip',
                  variable=var18,onvalue=1,command=dru,
                  offvalue=0).grid(row=9,column=0,sticky=W)
Dr=Checkbutton(menu,text='Driving when unfit to drive \t\t',font=('arial 16 bold'),
               bg='papaya whip',variable=var19,onvalue=1,command=dre,
               offvalue=0).grid(row=10,column=0,sticky=W)
First=Checkbutton(menu,text='First-Time',font=('arial 16 bold'),bg='papaya whip',
                  variable=var20,onvalue=1,command=First2,offvalue=0
                  ).grid(row=10,column=1,sticky=W)
Second=Checkbutton(menu,text='Second-Time',font=('arial 16 bold'),bg='papaya whip',
...
Accident=Checkbutton(menu,text='Offence relating to accident\t\t\t',font=('arial 16 bold'),
                     bg='papaya whip',variable=var22,onvalue=1,command=accidentee,
                     offvalue=0).grid(row=11,column=0,sticky=W)

Racing=Checkbutton(menu,text='Racing and Speeding\t\t\t',font=('arial 16 bold'),
                   bg='papaya whip',variable=var23,onvalue=1,command=race,
                   offvalue=0).grid(row=12,column=0,sticky=W)

Uniserved=Checkbutton(menu,text='Disobeying Covid19 Guidelines\t\t\t',font=('arial 16 bold'),
                      bg='papaya whip',variable=var24,onvalue=1,command=unise,
...
Taking=Checkbutton(menu,text='Taking vechicle without lawful authority\t\t\t\t\t',font=('arial 16 bold'),
                   bg='papaya whip',variable=var25,onvalue=1,command=take,
                   offvalue=0).grid(row=14,column=0,sticky=W)
Causing=Checkbutton(menu,text='Causing obstruction to free flow of traffic:/t/t/t',font=('arial 16 bold'),
                    bg='papaya whip',variable=var26,onvalue=1,command=cause,
...
gendertxt=Entry(intro,textvariable=gender,font=('arial 16 bold'),width=8,justify=LEFT)
...
gendertxt.grid(row=3,column=1)
gendertxt['value']=("","Male","Female","Transgender")
gendertxt.current(0)
#----------------
...
total=Button(intro,bg='lightgoldenrod',text='Total',padx=5,pady=10,bd=7,width=7,
             font=('arial 16 bold'),command=cost).grid(row=10,column=0,sticky=W)
recipt=Button(intro,bg='lightgoldenrod',text='Receipt',padx=5,pady=10,bd=7,width=7,
              font=('arial 16 bold'),command=recipt).grid(row=10,column=1,sticky=W)
resets=Button(intro,bg='lightgoldenrod',text='Reset',padx=5,pady=10,bd=7,width=7,
...
btnExit=Button(intro,font=('arial 16 bold'),text="Exit",padx=5,pady=10,bd=7,width=7,
                   bg ='firebrick3',command=iExit).grid(row=11,column=1,sticky=W)
btnsearch=Button(intro1,bg='aquamarine',padx=16,pady=4,bd=7,font=('arial 20 bold'),width=10,
